...
namespace Kanstraction.Migrations
{
    ...
    [Migration("20250924190000_MakeMaterialUsagePresetQtyNullable")]
    partial class MakeMaterialUsagePresetQtyNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kanstraction.Entities.BuildingTypeMaterialUsage", b =>
                {
                    ...
                    b.HasIndex("MaterialUsagePresetId");
            ...
            modelBuilder.Entity("Kanstraction.Entities.BuildingTypeMaterialUsage", b =>
                {
                    ...
                    b.HasOne("Kanstraction.Entities.MaterialUsagePreset", "MaterialUsagePreset")
                        .WithMany()
                        .HasForeignKey("MaterialUsagePresetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BuildingType");

                    b.Navigation("MaterialUsagePreset");
                });
